 ...
 */
final class Version20250126160438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE estilo (id INT AUTO_INCREMENT NOT NULL, estilo_musical_preferido_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, descripcion VARCHAR(255) NOT NULL, INDEX IDX_E0973A531C9C8804 (estilo_musical_preferido_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE estilo ADD CONSTRAINT FK_E0973A531C9C8804 FOREIGN KEY (estilo_musical_preferido_id) REFERENCES perfil (id)');
